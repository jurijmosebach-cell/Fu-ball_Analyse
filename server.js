// server.js – komplette Version für xG Value Dashboard
...
function computeBTTS(homeLambda, awayLambda, homeStats=null, awayStats=null){
  let pHomeAtLeast1 = 1 - poisson(0, homeLambda);
  let pAwayAtLeast1 = 1 - poisson(0, awayLambda);
...
async function fetchTeamStats(teamId, opts={limit:5}){
  ...
  try{
    ...
    console.warn("fetchTeamStats error",teamId,e.message||e);
